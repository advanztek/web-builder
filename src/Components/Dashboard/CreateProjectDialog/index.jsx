...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Grid, Card, CardContent, Typography, useTheme } from '@mui/material';
import { AutoAwesome, EditNote } from '@mui/icons-material';

const CreateProjectDialog = ({ open, onClose, onChoiceAI, onChoiceManual }) => {
